  ...
  test "endgame" do
    board = %Board{
      ...
      grid: %{
				...
				{0, 4} => %Unit{attack: :immobile, defense: 0, name: :bomb, position: :north, triggers: %{death: Unit.Ability.Poison, move: Board.Action.Ability.Immobile}, visible: MapSet.new([:player])}, 
				...
				{1, 2} => :water, 
				{1, 3} => :water, 
				{2, 0} => %Unit{attack: :immobile, defense: 0, name: :bomb, position: :south, triggers: %{death: Unit.Ability.Poison, move: Board.Action.Ability.Immobile}, visible: MapSet.new([:player])}, 
				{2, 1} => %Unit{attack: 9, defense: 0, name: :spy, position: :south, triggers: %{}, visible: MapSet.new([:player])}, 
				{2, 4} => %Unit{attack: :immobile, defense: 0, monarch: true, name: :"northern colors", position: :north, triggers: %{death: Unit.Ability.Concede, move: Board.Action.Ability.Immobile}, visible: MapSet.new([:player])}, 
				{3, 0} => %Unit{attack: 7, defense: 8, name: :general, position: :south, triggers: %{}, visible: MapSet.new([:player])}, 
				{3, 1} => %Unit{attack: :immobile, defense: 0, monarch: true, name: :"southern banner", position: :south, triggers: %{death: Unit.Ability.Concede, move: Board.Action.Ability.Immobile}, visible: MapSet.new([:player])}, 
				...
				{4, 1} => %Unit{attack: :immobile, defense: 0, name: :bomb, position: :south, triggers: %{death: Unit.Ability.Poison, move: Board.Action.Ability.Immobile}, visible: MapSet.new([:player])}, 
				{4, 2} => :block, 
				{4, 3} => :block, 
				...
				{5, 4} => %Unit{attack: :immobile, defense: 0, name: :bomb, position: :north, triggers: %{death: Unit.Ability.Poison, move: Board.Action.Ability.Immobile}, visible: MapSet.new([:player])}, 
