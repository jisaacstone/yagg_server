...
function game() {
    const eventDiv = document.getElementById('events'), nameForm = document.getElementById('name'), hostForm = document.getElementById('host'), errorDiv = document.getElementById('error'), joinButton = document.getElementById('joinbutton'), leaveButton = document.getElementById('leavebutton'), readyButton = document.getElementById('readybutton');
    ...
    function gamestate() {
        const host = hostForm.value, name = nameForm.value, oReq = new XMLHttpRequest(), uReq = new XMLHttpRequest();
...
onload = function () {
    const G = game(), host = window.location.hostname, port = window.location.port, hostname = port ? `${host}:${port}` : host;
